...
class HeatingMatChecklistScreen extends StatefulWidget {
  ...
  @override
  State<HeatingMatChecklistScreen> createState() =>
      _HeatingMatChecklistScreenState();
}
...
class _HeatingMatChecklistScreenState extends State<HeatingMatChecklistScreen> {
  ...
  late List<ChecklistStep> steps = [
    ChecklistStep('1. Pre-Installation Checks', [
      ...
      ChecklistItem(
        2,
        'Plan mat layout, staying 50–100mm from walls and fixtures.',
      ),
      ChecklistItem(3, 'Confirm correct product output.'),
      ChecklistItem(
        4,
        'Perform initial resistance tests (Continuity & Insulation) and record results.',
      ),
      ChecklistItem(
        5,
        'Install floor sensor conduit from thermostat location to a central point in the heated area.',
      ),
    ]),
    ChecklistStep('2. Laying the Mat', [
      ...
      ChecklistItem(
        8,
        'To turn, cut the MESH ONLY. Never cut the heating cable.',
      ),
      ChecklistItem(
        9,
        'Position the mat so the cold tail can reach the thermostat/junction box.',
      ),
      ChecklistItem(
        10,
        'Secure the mat to the sub-floor using the built-in tape.',
      ),
      ChecklistItem(
        11,
        'Perform a second round of resistance tests and record results.',
      ),
    ]),
    ChecklistStep('3. Electrical Connections', [
      ChecklistItem(
        12,
        'Ensure all electrical work complies with local regulations.',
      ),
      ChecklistItem(
        13,
      ...
      ChecklistItem(
        14,
        'Connect the heating mat power leads to the thermostat.',
      ),
    ...
    ChecklistStep('4. Final Checks & Handover', [
      ChecklistItem(
        16,
        'Take a photo of the completed installation before the floor covering is laid.',
      ),
      ChecklistItem(
        17,
        'Perform the final resistance tests after floor covering is laid and record.',
      ),
      ChecklistItem(
        18,
        'Advise the homeowner not to switch the system on until adhesive/levelling compound is fully cured.',
      ),
      ChecklistItem(
        19,
        'Tap Finish and use our warranty registration section to register the warranty.',
      ),
    ]),
  ];
